...
@section('content')
    ...
    <div class="form-group">
        {!! Form::submit('Create a new notice', ['class' => 'btn btn-primary form-control']) !!}
    </div>
